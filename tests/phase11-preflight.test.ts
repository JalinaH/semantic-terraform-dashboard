...
function run() {
  return {
    ...
    mutationEligible: true, mutationEligibilityLevel: null, mutationEligibilityReason: "verified_terraform_patch",
    ...
    configSnapshot: { terraformDir: ".", terraformVersion: "1.15.7" },
